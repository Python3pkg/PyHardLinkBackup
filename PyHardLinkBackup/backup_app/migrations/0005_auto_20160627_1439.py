...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='directory',
            field=models.CharField(unique=True, help_text='The path in the backup without datetime and filename', max_length=1024),
        ),
        migrations.AlterField(
            model_name='backupentry',
            name='file_mtime_ns',
            field=models.PositiveIntegerField(help_text='Time of most recent content modification expressed in nanoseconds as an integer.'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(unique=True, help_text='backup_datetime of a started backup. Used in all path as prefix.'),
        ),
        migrations.AlterField(
            model_name='backuprun',
            name='completed',
